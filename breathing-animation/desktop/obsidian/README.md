...
This directory contains an Obsidian plugin that embeds the breathing visualizer directly into your notes.
...
1.  Copy to `.obsidian/plugins/mindful-breathing`.
2.  Enable in Obsidian Community Plugins.
3.  Run command: `Open Breathing Visualizer`.
