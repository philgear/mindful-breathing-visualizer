...
function activate(context) {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand('mindful-breathing.box', () => startBreathing('box'))
  );
  context.subscriptions.push(
    vscode.commands.registerCommand('mindful-breathing.diaphragmatic', () =>
      startBreathing('diaphragmatic')
    )
  );
  context.subscriptions.push(
    vscode.commands.registerCommand('mindful-breathing.alternate', () =>
      startBreathing('alternate')
    )
  );

  // Command picker
  context.subscriptions.push(
    vscode.commands.registerCommand('mindful-breathing.select', async () => {
  ...
  // Shape picker
  context.subscriptions.push(
    vscode.commands.registerCommand('mindful-breathing.selectShape', async () => {
